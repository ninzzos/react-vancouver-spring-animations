...
<FadeIn>
  <span style={{ fontSize: "125px", margin: 15 }}>💯</span>
</FadeIn>
...
<Appear>
  <br />
  <span>Performant 🏃🏽‍♀️</span>
  <span>Natural 🌱</span>
  <span>Easy to write ✏️</span>
  <span>Easy to scale 👯‍♀️</span>
</Appear>
...
<CodeSurfer>
  ...
  ```js file=./components/transition.js 8:45
  ```
